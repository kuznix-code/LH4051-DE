...
void load_shell_css(void) {
    ...
    gtk_css_provider_load_from_string(provider,
        ...
        ".lh-explorer { background:#f5f5f5; color:#17212a; } .lh-start-item:hover { background:#d7e8f3; } .lh-start-search { margin:6px 8px; } .lh-start-section { font-weight:bold; padding:8px 10px 4px; color:#334b5c; } .lh-settings { background:#edf2f5; } .lh-settings-card { margin:10px; padding:14px; background:white; border:1px solid #b8c4cc; border-radius:5px; } .lh-store { background:#eef3f6; } .lh-store-card { margin:10px; padding:12px; background:white; border:1px solid #b8c4cc; border-radius:5px; } .lh-titlebar { background:linear-gradient(#dfe5e9,#9ba8b1); color:#17212a; } .lh-close { background:linear-gradient(#ef665e,#b52c28); color:white; min-width:42px; }"
        ".lh-toolbar { background:#e2e6e8; border-bottom:1px solid #aab2b7; } .lh-phode { background:linear-gradient(90deg,#3982bd,#8bbce0); color:white; padding:14px; } .lh-filter { background:#e8ecef; border-right:1px solid #bdc5ca; } .lh-menu { background:#f0f0f0; } .lh-settings-heading { font-size:16px; font-weight:bold; color:#334b5c; } .lh-settings-description { color:#52636e; } .lh-store-section { font-weight:bold; padding:6px 10px; color:#334b5c; } .lh-store-app { margin:2px 10px; padding:8px; } .lh-store-results { margin:10px; padding:8px; } scrollbar slider { min-width:8px; min-height:8px; }"
    );

...
void load_shell_css(void) {
    ...
    gtk_css_provider_load_from_string(provider,
        ...
        ".lh-start-menu { background:#e9e5d8; border:1px solid #87909a; }"
        ".lh-start-left { background:linear-gradient(180deg,#5d7385,#263541); color:white; }"
        ".lh-start-header { padding:12px; font-weight:bold; font-size:16px; }"
        ".lh-start-item { min-height:42px; margin:2px 8px; padding:5px 8px; border-radius:3px; }"
        ".lh-start-right { color:#26313a; padding:10px; }"
        ".lh-explorer { background:#f5f5f5; } .lh-titlebar { background:linear-gradient(#dfe5e9,#9ba8b1); color:#17212a; }"
        ".lh-close { background:linear-gradient(#ef665e,#b52c28); color:white; min-width:42px; }"
        ".lh-toolbar { background:#e2e6e8; border-bottom:1px solid #aab2b7; }"
        ".lh-phode { background:linear-gradient(90deg,#3982bd,#8bbce0); color:white; padding:14px; }"
        ".lh-filter { background:#e8ecef; border-right:1px solid #bdc5ca; } .lh-menu { background:#f0f0f0; }"
    );
